...
public class CFourmi {
    // Tableau des incrémentations à effectuer sur la position des fourmis en fonction de la direction du deplacement.
    ...
    // Pas d'incrémentation des directions suivant le nombre de directions allouées à la fourmi.
    ...
    public CFourmi(Color pCouleurDeposee, Color pCouleurSuivie, float pProbaTD, float pProbaG, float pProbaD, float pProbaSuivre, CPainting pPainting, char pTypeDeplacement, float pInit_x, float pInit_y, int pInitDirection, int pTaille, float pSeuilLuminance, PaintingAnts pApplis) {
        ...
        // Nombre de directions pouvant être prises : 2 types de déplacements possibles.
    ...
    /**
     * Titre : void deplacer().
     * Description : Fonction de deplacement de la fourmi.
     */
    public synchronized void deplacer() {
        ...
        // Le tableau dir contient 0 si la direction concernée ne contient pas la couleur à suivre, et 1 sinon (dir[0]=gauche, dir[1]=tt_droit, dir[2]=droite).
        ...
        // Tirage d'un nombre aléatoire permettant de savoir si la fourmi va suivre ou non la couleur.
    ...
    /**
     * Titre : modulo Description : Fcontion de modulo permettant au fourmi de reapparaitre de l autre coté du Canvas lorsque qu'elle sorte de ce dernier.
     * @param x : valeur.
     * @return int.
     */
    ...
    /**
     * Titre : boolean testCouleur() Description : fonction testant l'égalité d'une couleur avec la couleur suivie.
     */
